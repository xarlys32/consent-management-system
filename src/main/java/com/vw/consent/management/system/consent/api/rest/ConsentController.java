...
public class ConsentController {
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<ConsentAuditHistoryView> getConsentAuditByUserId(@PathVariable String userId) {
        ...
        ConsentAuditHistoryView responseDTO = consentAuditDTOMapper.
